...
// import closeButton from "../assets/circle-empty-remove.png";
                        ...
                        <tbody id="repeat">
                            <tr>
                                <td id="size">
                                    ...
                                    />
                                    &nbsp;
                                    <span id="currency" className="ng-binding">
                                        USD - United States Dollar
                                    </span>
                                </td>
                                <td id="size1" className="symbol ng-binding">
                                    <img height="15" alt="" />$
                                </td>
                                <td id="size2" className="ng-binding">
                                    1.0000
                                </td>
                                <td style={{ cursor: "pointer" }} id="last">
                                    <img
